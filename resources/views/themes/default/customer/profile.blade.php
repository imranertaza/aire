                    ...
                    <form action="{{ route('customer.profile.update') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="card border-light-subtle shadow-sm rounded-4 bg-white mb-4">
                            <div class="card-header bg-white border-bottom px-4 py-3 rounded-top-4">
                                <h5 class="mb-0 fw-bold fs-16 text-dark"><i
                                        class="bi bi-person me-2 text-primary"></i>Personal Information</h5>
                            </div>
                            <div class="card-body p-4">
                                ...
                                <div class="d-flex align-items-center gap-4 mb-4">
                                    ...
                                    <div>
                                        <label for="pic"
                                            class="btn btn-outline-secondary rounded-2 fs-13 fw-semibold mb-1">
                                ...
                                <div class="row g-3">
                                    <div class="col-sm-6">
                                        ...
                                        <input type="text" name="firstname"
                                            ...
                                            class="form-control shadow-none fs-14 @error('firstname') is-invalid @enderror"
                                            required>
                                        @error('firstname')
                                    ...
                                    <div class="col-sm-6">
                                        ...
                                        <input type="text" name="lastname"
                                            ...
                                            class="form-control shadow-none fs-14 @error('lastname') is-invalid @enderror"
                                            required>
                                        @error('lastname')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    ...
                                    <div class="col-sm-6">
                                        ...
                                        <input type="email" name="email" value="{{ old('email', $customer->email) }}"
                                            class="form-control shadow-none fs-14 @error('email') is-invalid @enderror"
                                            required>
                                        @error('email')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                        ...
                        <div class="card border-light-subtle shadow-sm rounded-4 bg-white mb-4">
                            <div class="card-header bg-white border-bottom px-4 py-3 rounded-top-4">
                                <h5 class="mb-0 fw-bold fs-16 text-dark"><i
                                        class="bi bi-shield-lock me-2 text-primary"></i>Security & Password <span
                                        class="fs-13 text-muted fw-normal">(leave blank to keep current)</span></h5>
                            </div>
                            <div class="card-body p-4">
                                <div class="row g-3">
                                    <div class="col-sm-4">
                        ...
                        <div class="d-flex justify-content-end gap-2">
                            <a href="{{ route('customer.dashboard') }}"
                                class="btn btn-outline-secondary rounded-2 fw-semibold px-4 fs-14">Cancel</a>
