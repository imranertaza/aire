                ...
                <div class="col-lg-9">
                    <div class="card border-light-subtle shadow-sm rounded-4 bg-white p-4">
                        <div class="d-flex flex-wrap align-items-center justify-content-between mb-4">
                            <div>
                                <h4 class="fw-bold text-dark mb-1 fs-18"><i class="bi bi-box-seam text-primary me-2"></i>My
                                    Orders</h4>
                                        ...
                                        @foreach ($orders as $order)
                                            <tr>
                                                ...
                                                <td class="fs-13 text-secondary">
                                                    <div class="fw-semibold text-dark">{{ $order->shipping_firstname }}
                                                        {{ $order->shipping_lastname }}</div>
                                                ...
                                                <td>
                                                    <span
                                                        class="badge bg-primary-subtle text-primary rounded-pill fs-12 px-3 py-1">
