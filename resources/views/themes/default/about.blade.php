...
@section('meta_description',
    'Learn about AIRE Industries — our mission, team, and commitment to delivering healthier
    indoor air environments through cutting-edge technology.')
...
@section('content')
    <main class="container main-container">
        ...
        <div class="row g-0">
            ...
            <div class="{{ $hasAds ? 'col-lg-9 col-xl-6' : 'col-lg-9 col-xl-9' }} center-feed px-lg-4 pb-5">
                ...
                <div id="story" class="content-section mb-5 pb-4">
                    ...
                    <div class="row g-3 mb-5 pb-5">
                        <div class="col-6 col-md-3">
                            <div
                                class="text-center rounded-4 p-4 d-flex flex-column justify-content-center about-stat-card">
            ...
            @if ($hasAds)
                ...
                <aside class="col-lg-12 col-xl-3 border-left1px d-none d-xl-block">
