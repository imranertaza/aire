                        ...
                        <div class="col-md-6">
                            <div class="solution-card">
                                ...
                                <div class="card-content">
                                    ...
                                    <a href="{{ route('products.detail', 1) }}" class="card-link fs-12 mt-auto">VIEW PRODUCT
                        ...
                        <div class="col-md-6">
                            <div class="solution-card">
                                ...
                                <div class="card-content">
                                    ...
                                    <a href="{{ route('products.landing') }}" class="card-link fs-12 mt-auto">VIEW PRODUCT
                                        <i class="bi bi-arrow-right"></i></a>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="solution-card">
                                ...
                                <div class="card-content">
                                    ...
                                    <a href="#" class="card-link fs-12 mt-auto">VIEW PRODUCT <i
