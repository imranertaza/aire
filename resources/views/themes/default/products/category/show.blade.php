...
@section('title', !empty($category->meta_title) ? $category->meta_title : 'Aire | ' . ($category->category_name ??
    'Category'))
    ...
    @if (!empty($category->image))
        @section('og_image', getImagePath($category->image))
    @endif
    @section('canonical_url', route('category.show', $category->slug ?? $category->id))
