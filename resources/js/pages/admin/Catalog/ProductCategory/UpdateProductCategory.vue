                            ...
                            <div class="row">
                                ...
                                <div class="col-md-8">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select v-model="form.parent_id" class="form-control">
                                            ...
                                            <option v-for="cat in parentCategories" :key="cat.id" :value="cat.id" :disabled="cat.id === categoryId">
                                                {{ cat.category_name }}
                                            </option>
                                        </select>
                                    </div>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <Vue3Dropzone v-model="fileUpload" :initialFiles="initialFiles" :allowSelectOnPreview="true" @remove-file="removeFile" />
