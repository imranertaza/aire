    ...
    public function run(): void
    {
        ...
        Page::updateOrCreate(
            ...
            [
                ...
                'f_image'           => 'https://placehold.co/1200x500?text=About+Us',
        ...
        Page::updateOrCreate(
            ...
            [
                ...
                'f_image'           => 'https://placehold.co/1200x500?text=Contact+Us',
                'meta_title'        => $faker->sentence(5),
                'meta_description'  => $faker->sentence(20),
                'meta_keyword'      => implode(', ', $faker->words(6)),
                'status'            => 'Active',
        ...
        Page::updateOrCreate(
            ...
            [
                ...
                'f_image'           => 'https://placehold.co/1200x500?text=History',
                'meta_title'        => $faker->sentence(5),
                'meta_description'  => $faker->sentence(20),
                'meta_keyword'      => implode(', ', $faker->words(6)),
                'status'            => 'Active',
        ...
        Page::updateOrCreate(
            ...
            [
                ...
                'short_des'         => $faker->sentence(12),
                'page_description'  => '',
                'f_image'           => 'https://placehold.co/1200x500?text=Sports',
                'meta_title'        => $faker->sentence(5),
                'meta_description'  => $faker->sentence(20),
                'meta_keyword'      => implode(', ', $faker->words(6)),
                'status'            => 'Active',
